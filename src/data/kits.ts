...
/** Standard files every kit ships with. Always include first. */
...
export const KITS: Kit[] = [
  {
    ...
    priceCents: 1900,
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [
    ...
    keywords: [
      "nextjs", "next.js", "next 14", "next 15", "app router", "typescript",
      "ts", "react", "supabase", "rls", "server actions", "edge", "claude code",
      "cursor", "saas", "production",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    keywords: [
      "supabase", "postgres", "schema", "migration", "rls", "row level security",
      "multi-tenant", "tenancy", "auth.uid", "policy", "saas database",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    keywords: [
      "stripe", "stripe connect", "payments", "marketplace", "revenue share",
      "rev share", "split payment", "webhook", "refund", "chargeback", "payouts",
      "destination charge",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    tagline:
      "Turn your AI into a back-office for certs, safety paperwork, and onboarding documents.",
    description:
    ...
    keywords: [
      "construction", "trades", "pipefitter", "welder", "electrician", "scaffolder",
      "safety", "ohs", "toolbox talk", "fit for duty", "certification", "ticket",
      "onboarding", "contractor", "subcontractor",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    keywords: [
      "founder", "startup", "pitch deck", "investor update", "hiring",
      "job description", "runway", "fundraise", "seed", "pre-seed", "moat",
      "narrative",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    tagline:
      "Design principles, copy patterns, progressive disclosure, and sensible defaults baked into every prompt.",
    description:
    ...
    keywords: [
      "ux", "design", "apple", "hig", "human interface guidelines", "copywriting",
      "microcopy", "progressive disclosure", "premium", "minimal", "accessibility",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    tagline:
      "MLS-ready listings, CMAs, neighborhood profiles, and the follow-up emails that actually close deals.",
    description:
    ...
    keywords: [
      "real estate", "realtor", "agent", "broker", "listing", "mls", "cma",
      "comparative market analysis", "open house", "buyer", "seller",
      "neighborhood", "property", "zillow", "redfin", "house", "condo", "luxury",
      "fixer", "follow-up",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    tagline:
      "Personalized cold emails, follow-up cadences, and reply handling that doesn't sound like a template.",
    description:
    ...
    keywords: [
      "sales", "cold email", "outreach", "sdr", "ae", "bdr", "prospecting",
      "follow-up", "follow up", "cadence", "linkedin", "personalization",
      "objection", "discovery", "demo", "lost deal", "nurture",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    tagline:
      "Proposals, SOWs, intake forms, invoice nudges, and the visibility posts that bring the next client.",
    description:
    ...
    keywords: [
      "freelance", "freelancer", "consultant", "indie", "solo", "solopreneur",
      "proposal", "sow", "scope of work", "statement of work", "intake", "invoice",
      "client update", "niche", "pricing", "contract", "linkedin",
  ...
  },
  {
    ...
    tagline:
      "Keyword-clustered outlines, longform article generation, meta optimization, schema markup, and refresh prompts.",
    description:
    ...
    keywords: [
      "seo", "content", "writer", "blog", "article", "longform", "outline",
      "keyword", "meta description", "title tag", "schema markup", "faq",
      "how-to", "serp", "intent", "ranking", "refresh",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    tagline:
      "JDs that read like a person wrote them, Boolean searches that find the right candidates, outreach that gets replies.",
    description:
    ...
    keywords: [
      "recruiter", "recruiting", "talent", "sourcing", "boolean", "linkedin",
      "jd", "job description", "outreach", "candidate", "interview",
      "behavioral", "technical", "reference check", "offer letter", "rejection",
      "ats",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    tagline:
      "Résumé tailoring per JD, cover letters, LinkedIn rewrites, interview prep, and post-interview follow-ups.",
    description:
    ...
    keywords: [
      "resume", "résumé", "cv", "cover letter", "linkedin", "job search",
      "interview", "star", "behavioral", "technical interview", "follow up",
      "rejection", "ats", "keyword", "tailoring",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    tagline:
      "PRDs, roadmap docs, sprint planning, stakeholder updates, and the metrics-review prompts that make exec readouts easy.",
    description:
    ...
    keywords: [
      "pm", "product manager", "prd", "spec", "roadmap", "now next later",
      "sprint", "planning", "stakeholder", "update", "metrics", "kpi", "okr",
      "north star",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    tagline:
      "Issue outliner, headline tester, hook generator, growth-loop ideas, and re-engagement copy that actually re-engages.",
    description:
    ...
    keywords: [
      "newsletter", "substack", "beehiiv", "convertkit", "mailchimp", "headline",
      "subject line", "intro hook", "open rate", "click rate", "growth loop",
      "cross-promotion", "re-engagement", "churn",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    tagline:
      "Apple HIG patterns, App Store readiness, SwiftData + CloudKit examples, accessibility patterns, and the SwiftUI gotchas you keep hitting.",
    description:
    ...
    keywords: [
      "ios", "swift", "swiftui", "swiftdata", "cloudkit", "hig", "app store",
      "tca", "observable", "actor", "concurrency", "accessibility", "apple",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    tagline:
      "Pandas / DuckDB / Plotly recipes, EDA prompts, statistical-test cookbook, and the SQL→pandas idioms you keep googling.",
    description:
    ...
    keywords: [
      "python", "pandas", "duckdb", "plotly", "matplotlib", "seaborn", "eda",
      "statistics", "hypothesis test", "p-value", "regression", "sql", "polars",
      "jupyter", "notebook",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    keywords: [
      "customer support", "support", "csm", "escalation", "refund", "lost order",
      "shipping", "nps", "detractor", "upsell", "tone", "saas support",
      "ecommerce support",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    tagline:
      "Hand the AI 3-5 samples of your writing and it produces a voice profile you can apply to every future asset.",
    description:
    ...
    keywords: [
      "brand", "brand voice", "tone", "voice and tone", "style guide", "copy",
      "messaging", "consistency", "on-brand", "off-brand", "personality",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    tagline:
      "Client comms, session notes, intake forms, and content marketing for solo practitioners — with disclaimers baked in.",
    description:
    ...
    keywords: [
      "coach", "coaching", "trainer", "therapist", "counselor", "wellness",
      "session notes", "soap notes", "intake", "client", "practitioner",
      "private practice", "disclaimer",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    tagline:
      "Product descriptions, ad copy for Meta / Google / TikTok, review responses, abandoned-cart sequences, supplier emails.",
    description:
    ...
    keywords: [
      "ecommerce", "shopify", "dtc", "product description", "meta ads", "google ads",
      "tiktok ads", "abandoned cart", "klaviyo", "review response", "supplier",
      "wholesale",
    ],
    whatsInside: [
  ...
  },
  {
    ...
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [],
    keywords: ["dev", "android", "kotlin", "mobile"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_ANDROID_KOTLIN",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "patterns/compose-and-material3.md", "quick-start.md"],
  },
  {
    ...
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [],
    keywords: ["dev", "data", "etl", "pipelines"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_DATA_ENGINEER_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "patterns/dbt-models-and-quality.md", "quick-start.md"],
  },
  {
    id: "devops-terraform",
    ...
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [],
    keywords: ["dev", "devops", "terraform", "aws"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_DEVOPS_TERRAFORM",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "patterns/terraform-modules-and-iam.md", "quick-start.md"],
  },
  {
    id: "go-backend",
    slug: "go-backend",
    ...
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [],
    keywords: ["dev", "go", "backend"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_GO_BACKEND",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "patterns/idiomatic-go-and-grpc.md", "quick-start.md"],
  },
  {
    id: "graphql-design",
    slug: "graphql-design",
    ...
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [],
    keywords: ["dev", "graphql", "api"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_GRAPHQL_DESIGN",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "patterns/schema-and-resolvers.md", "quick-start.md"],
  },
  {
    id: "kubernetes-pro",
    slug: "kubernetes-pro",
    ...
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [],
    keywords: ["dev", "kubernetes", "devops"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_KUBERNETES_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "patterns/deployments-and-observability.md", "quick-start.md"],
  },
  {
    id: "ml-engineer-pro",
    ...
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [],
    keywords: ["dev", "ml", "machine-learning", "python"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_ML_ENGINEER_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/model-card-and-eval.md"],
  },
  {
    id: "node-backend",
    slug: "node-backend",
    ...
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [],
    keywords: ["dev", "node", "backend", "typescript"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_NODE_BACKEND",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "patterns/error-handling-and-observability.md", "quick-start.md"],
  },
  {
    id: "postgres-dba",
    slug: "postgres-dba",
    ...
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [],
    keywords: ["dev", "postgres", "database", "dba"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_POSTGRES_DBA",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "patterns/indexing-and-explain.md", "quick-start.md"],
  },
  {
    id: "python-backend",
    slug: "python-backend",
    ...
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [],
    keywords: ["dev", "python", "django", "fastapi"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_PYTHON_BACKEND",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "patterns/django-vs-fastapi-and-async.md", "quick-start.md"],
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["dev", "qa", "testing", "playwright"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_QA_TEST_AUTOMATION",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "patterns/playwright-cypress-flake-reduction.md", "quick-start.md"],
  },
  {
    id: "rails-backend",
    slug: "rails-backend",
    ...
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [],
    keywords: ["dev", "ruby", "rails", "backend"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_RAILS_BACKEND",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "patterns/activerecord-and-deployment.md", "quick-start.md"],
  },
  {
    id: "react-native-dev",
    ...
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [],
    keywords: ["dev", "react-native", "mobile", "typescript"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_REACT_NATIVE_DEV",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "patterns/component-and-native-modules.md", "quick-start.md"],
  },
  {
    id: "rest-api-design",
    ...
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [],
    keywords: ["dev", "rest", "api"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_REST_API_DESIGN",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "patterns/resources-versioning-errors.md", "quick-start.md"],
  },
  {
    ...
    aiTargets: ["claude-code", "claude", "cursor"],
    personas: [],
    keywords: ["dev", "security", "engineering"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_SECURITY_ENGINEER",
    deliverables: ["SKILL.md", "checklists/threat-model-and-incident-runbook.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md"],
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["finance", "accounting", "bookkeeping"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_ACCOUNTANT_BOOKKEEPER",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "reference-workflows.md"],
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["finance", "advisory", "wealth"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["finance", "insurance", "agent"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["finance", "mortgage", "lending"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["real-estate", "investing", "rentals"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["coaching", "leadership", "executive"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_EXECUTIVE_COACH",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "reference-workflows.md", "templates/client-comms.md", "templates/frameworks.md"],
  },
  {
    id: "hr-generalist",
    slug: "hr-generalist",
    ...
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "reference-workflows.md", "templates/policy-drafts.md"],
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["hr", "recruiting", "corporate"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_INTERNAL_RECRUITER",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "reference-workflows.md", "templates/candidate-communication.md", "templates/hiring-manager-intake.md", "templates/jd-calibration.md", "templates/offer-and-close.md"],
  },
  {
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["hr", "recruiting", "sourcing"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_TALENT_ACQUISITION",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "reference-workflows.md", "templates/candidate-marketing.md", "templates/pipeline-metrics.md", "templates/sourcing-strategies.md"],
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["operations", "compliance", "audit"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["operations", "executive-assistant", "va"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["operations", "office", "admin"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["operations", "ops", "process"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_OPERATIONS_MANAGER",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "reference-workflows.md", "templates/sop-customer-escalation.md", "templates/sop-end-of-month-close.md", "templates/sop-vendor-onboarding.md"],
  },
  {
    id: "procurement-pro",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["operations", "procurement", "sourcing"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["operations", "pmp", "project-management"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["operations", "risk", "enterprise"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["operations", "agile", "scrum"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["trades", "contractor", "construction"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["trades", "handyman", "maintenance"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["trades", "landscaping", "seasonal"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["trades", "roofing", "insurance"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["service", "auto", "mechanic"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["service", "moving", "logistics"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["hospitality", "airbnb", "short-term-rental"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["hospitality", "cafe", "coffee"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["hospitality", "catering", "events"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["hospitality", "restaurant", "food"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["events", "flowers", "design"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["creative", "photography", "events"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_PHOTOGRAPHER_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "reference-workflows.md", "templates/portrait-commercial-proposals.md", "templates/wedding-proposals-shotlists.md"],
  },
  {
    id: "videographer-pro",
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["events", "wedding", "planner"],
    whatsInside: [],
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["creator", "blog", "seo"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_BLOGGER_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "playbooks/pillar-content-and-monetization.md", "quick-start.md"],
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["creator", "instagram", "social"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_INSTAGRAM_INFLUENCER",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/pillar-and-caption-library.md"],
  },
  {
    id: "linkedin-creator",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["creator", "linkedin", "b2b"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_LINKEDIN_CREATOR",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "frameworks/post-styles-by-goal.md", "memory.md", "optimization-pack.md", "quick-start.md"],
  },
  {
    id: "podcaster-pro",
    slug: "podcaster-pro",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["creator", "podcast", "audio"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_PODCASTER_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/episode-prep-and-shownotes.md"],
  },
  {
    id: "tiktok-creator",
    slug: "tiktok-creator",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["creator", "tiktok", "social"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_TIKTOK_CREATOR",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "frameworks/hook-frameworks.md", "memory.md", "optimization-pack.md", "quick-start.md"],
  },
  {
    id: "twitch-streamer",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["creator", "twitch", "streaming"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_TWITCH_STREAMER",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/sponsor-deck-and-pitches.md"],
  },
  {
    id: "youtuber-creator",
    ...
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "frameworks/title-and-thumbnail-frameworks.md", "memory.md", "optimization-pack.md", "quick-start.md"],
  },
  {
    id: "author-novelist",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["writing", "fiction", "author"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_AUTHOR_NOVELIST",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/query-and-synopsis.md"],
  },
  {
    id: "comedy-writer",
    slug: "comedy-writer",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["writing", "comedy", "entertainment"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_COMEDY_WRITER",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "frameworks/joke-structures-and-bits.md", "memory.md", "optimization-pack.md", "quick-start.md"],
  },
  {
    id: "screenwriter-pro",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["writing", "screenwriting", "film"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_SCREENWRITER_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "frameworks/loglines-and-beat-sheets.md", "memory.md", "optimization-pack.md", "quick-start.md"],
  },
  {
    id: "songwriter-pro",
    slug: "songwriter-pro",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["writing", "songwriting", "music"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_SONGWRITER_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "frameworks/song-structure-and-rhyme.md", "memory.md", "optimization-pack.md", "quick-start.md"],
  },
  {
    id: "speechwriter-pro",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["writing", "speech", "communications"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_SPEECHWRITER_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "frameworks/openers-structures-closers.md", "memory.md", "optimization-pack.md", "quick-start.md"],
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["writing", "translation", "localization"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_TRANSLATOR_LOCALIZATION",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/style-guide-and-glossary.md"],
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["creative", "design", "illustration"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_GRAPHIC_DESIGNER_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/briefs-proposals-rationale.md"],
  },
  {
    id: "music-producer",
    slug: "music-producer",
  ...
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["creative", "voice-acting", "audition"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_VOICE_ACTOR_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/audition-prep-and-demo-scripts.md"],
  },
  {
    id: "chiropractor-pro",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["healthcare", "chiropractor", "clinic"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_CHIROPRACTOR_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/intake-and-treatment-plans.md"],
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["healthcare", "nurse", "clinical"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_NURSE_PRACTITIONER",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/patient-education-and-summaries.md"],
  },
  {
    id: "pharmacist-pro",
    slug: "pharmacist-pro",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["healthcare", "pharmacist", "clinical"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_PHARMACIST_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/counseling-and-prior-auth.md"],
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["healthcare", "pt", "rehabilitation"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_PHYSICAL_THERAPIST",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/hep-and-progress-notes.md"],
  },
  {
    id: "veterinarian-pro",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["healthcare", "veterinary", "clinical"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_VETERINARIAN_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/client-education-and-discharge.md"],
  },
  {
    id: "estate-planning",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["personal", "estate", "legal"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_ESTATE_PLANNING",
    deliverables: ["SKILL.md", "checklists/will-and-executor-prep.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md"],
  },
  {
    id: "home-renovation",
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["personal", "renovation", "homeowner"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_HOME_RENOVATION",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/scope-and-change-orders.md"],
  },
  {
    id: "personal-finance",
    ...
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/budgets-debt-savings.md"],
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["personal", "travel", "itinerary"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_TRAVEL_PLANNER_PRO",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/itineraries-and-budgets.md"],
  },
  {
    ...
    aiTargets: ["any"],
    personas: [],
    keywords: ["personal", "wedding", "planning"],
    whatsInside: [],
    stripePriceEnv: "STRIPE_PRICE_WEDDING_PLANNING_SELF",
    deliverables: ["SKILL.md", "custom-gpt-instructions.md", "memory.md", "optimization-pack.md", "quick-start.md", "templates/budget-vendor-timeline.md"],
  },
];

// ====================================================================
// Bundles — 13-bundle layout for the 100-SKU catalog
// ====================================================================
...
export function bundleStandaloneTotal(bundle: Bundle): number {
...
/** Back-compat: prior rounds referenced a single `BUNDLE` constant. */
export const BUNDLE = BUNDLES.find((b) => b.slug === "everything-100")!;
