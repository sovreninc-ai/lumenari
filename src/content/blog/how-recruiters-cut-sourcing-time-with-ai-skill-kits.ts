...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "For solo recruiters or agency principals, the Pro+ subscription ($39 USD/mo) unlocks every kit on Lumenari plus future ones. If you'd reach for two or three different kits a year — and most recruiters working across role families would — Pro+ is the buy.",
      ],
    },
    {
  ...
  outro: [
    "The 2026 recruiting playbook is settled, and AI skill kits are now table stakes for any recruiter who wants to keep up. The Recruiter Pro at $14 is the lowest-friction starting point. Pro+ at $39 USD/mo is the move if you'd buy two or three kits this year. Either way, the time savings show up in the first week and compound from there.",
