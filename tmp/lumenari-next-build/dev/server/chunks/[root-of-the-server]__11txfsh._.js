...
"[project]/src/app/api/wishlist/save/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Body = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    kitSlug: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1).max(120),
...
async function POST(req) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$kits$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getKit"])(kitSlug) && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$kits$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getBundle"])(kitSlug)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const { data: existing } = await db.from("leads").select("id, unsubscribed_at").ilike("email", email).maybeSingle();
    let leadId;
    if (existing) {
        leadId = existing.id;
    ...
    const { data: wlExisting } = await db.from("wishlists").select("id").eq("lead_id", leadId).eq("kit_slug", kitSlug).maybeSingle();
    if (wlExisting) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
            leadId,
    ...
    const { data: inserted, error: wlErr } = await db.from("wishlists").insert({
        lead_id: leadId,
        kit_slug: kitSlug,
        source
    }).select("id").single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__11txfsh._.js.map