-- ====================================================================
-- Exemple de migration starter pour un SaaS multi-tenant.
-- Adaptez les noms — gardez la structure.
-- ====================================================================

create extension if not exists "pgcrypto";

-- --------------------------------------------------------------------
-- Cœur : organizations + memberships
-- --------------------------------------------------------------------
...
-- --------------------------------------------------------------------
-- Table métier : events (une ressource tenant-scoped typique)
-- --------------------------------------------------------------------
...
-- profiles : un utilisateur peut lire + mettre à jour son propre profil
...
-- organizations : les membres peuvent lire leurs orgs
create policy "organizations member read" on public.organizations
  for select using (public.is_member_of(id));

-- memberships : les membres peuvent lire leurs propres memberships
create policy "memberships self read" on public.memberships
  for select using (profile_id = auth.uid());

-- events : les membres lisent, les admins écrivent
