-- ====================================================================
-- Migration inicial de exemplo para um SaaS multi-tenant.
...
-- --------------------------------------------------------------------
-- Tabela de domínio: events (um recurso típico com escopo de tenant)
-- --------------------------------------------------------------------
...
-- profiles: um usuário pode ler + atualizar o próprio profile
