...
-- --------------------------------------------------------------------
-- ドメインテーブル: events（典型的なテナントスコープのリソース）
-- --------------------------------------------------------------------
...
-- profiles: ユーザーは自身のプロフィールを read + update できる
