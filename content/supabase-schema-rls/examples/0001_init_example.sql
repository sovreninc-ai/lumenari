-- ====================================================================
-- Example starter migration for a multi-tenant SaaS.
...
-- --------------------------------------------------------------------
-- Domain table: events (a typical tenant-scoped resource)
-- --------------------------------------------------------------------
...
-- memberships: members can read their own memberships
