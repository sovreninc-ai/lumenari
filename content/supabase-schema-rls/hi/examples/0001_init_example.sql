-- ====================================================================
-- एक multi-tenant SaaS के लिए example starter migration।
-- Names को adapt करें — structure रखें।
-- ====================================================================
...
-- --------------------------------------------------------------------
-- Domain table: events (एक typical tenant-scoped resource)
-- --------------------------------------------------------------------
...
-- profiles: एक user अपनी profile read + update कर सकता है
...
-- organizations: members अपनी orgs read कर सकते हैं
create policy "organizations member read" on public.organizations
  for select using (public.is_member_of(id));

-- memberships: members अपनी memberships read कर सकते हैं
